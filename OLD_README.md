> This is the original README for this project, by Simon Heimler (Fannon), kept
> verbatim as it stood before the 2.0 changes. It describes the app as a Light Guide
> bridge: guide notes arrive from Synthesia, Scaler 2 or any other MIDI source over a
> virtual loop port, and the app mirrors them onto the LinnStrument.
>
> All of that still works exactly as written here, and the setup instructions below
> are still the ones to follow. What the current [README](./README.md) adds is
> everything the app can now do on its own — opening a MIDI file directly, stepping
> through it, and reading the instrument's layout instead of being told about it.
>
> Kept for the history, and because this is the author's own account of what he built.
